...
<script>
import {getShopAllField} from '../../api/shop'
    export default {
        name: "Up",
        components:{},
      data(){
      ...
      created() {
        ...
        this.queryShop(this.$route.query.sid);
      ...
      methods:{
        async queryShop(sid){
           let {data:res} = await  getShopAllField(sid);
           let shop=res.data;
           this.inputs.sid=shop.sid;
           this.inputs.sidCid=shop.sidCid;
           this.inputs.name=shop.name;
           this.inputs.tags=shop.tags;
            this.inputs.preview=shop.preview;
            this.inputs.previewFid=shop.previewFid;
            this.inputs.discription=shop.discription;
          this.inputs.isquality=shop.isquality;
           this.inputs.isfree=shop.isfree;
            this.inputs.acoin=shop.acoin;
            this.inputs.coin=shop.coin;
            this.inputs.shopFid=shop.shopFid;
             this.inputs.adresss=shop.adresss;
              this.inputs.password=shop.password;
           this.inputs.detail=shop.detail;
             this.inputs.views=shop.views;
            this.inputs.downloads=shop.downloads;
              this.inputs.state=shop.state;
              this.image.path=shop.preview;
              this.image.fid=shop.previewFid;
          $("#myiframe").contents().find(".note-editable").html(shop.detail)
