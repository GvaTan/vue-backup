      ...
      <div class="container mt-4 pt-4 col-12 col-lg-7" >
          <form οnsubmit="return false;" class="layui-form" action="">
            <div class="layui-form-item">
                ...
                <input type="text" name="name" required  v-model="input.name"  lay-verify="required" placeholder="请输入网站名" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">网站地址</label>
                <div class="layui-input-block">
                <input type="text" name="url" required v-model="input.url" lay-verify="required" placeholder="务必http或者https开头,比如http://anets.top" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
           ...
           <input type="hidden" name="imgfid" v-model="image.imgfid">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                <input type="text" name="tags" v-model="input.tags" required  lay-verify="required" placeholder="多个标签逗号隔开，比如v.qq.com的标签： 视频 影音" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">描述</label>
                <div class="layui-input-block">
                <textarea name="discription" v-model="input.discription" placeholder="请输入简短描述，网站是干什么的" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
...
<script>
import {getTree,getUrl} from '../../api/index'
export default {
  name: 'upUrl',
  data(){
      return {
  ...
  created(){
      let a=prompt("输入授权密码：");
      if(a!="1632414557@tyb"){
          window.location.href='http://anets.top';
      }else{
           this.initTree()
           this.gainUrl()
      }
  ...
  methods:{
      async gainUrl(){
          let {data:res}=await getUrl(this.$route.query.wid);
          let urlz=res.data;
          this.input.name=urlz.name;
          this.input.wid=urlz.wid;
          this.input.url=urlz.url;
          this.input.tags=urlz.tags;
          this.input.discription=urlz.discription;
          this.image.img=urlz.img;
          this.image.imgfid=urlz.imgfid;
